    ...
    <main>
        <section class="row">
            ...
            <form action="inc/gallery/insert_gallery.php" method="post">
                <input type="text" name="name" id="name" placeholder="Názov obrázka">
            ...
            <?php
                ...
                echo '<table class="admin-table">';
                 foreach($Galeria as $g){
                        echo '<tr>';
                        echo '<td>'.$g->name;'</td>';
                        echo '<td>'.'<img width="200" src = "'.$g->path.'">';
                    ...
                    foreach($qna as $q){
                        ...
                        echo '<td colspan="4">
                                <form action="inc/qna/update_qna.php" method="post">
                                    ...
                                    <input type ="text" name="update_question" placeholder="Otázka">
                                    <input type ="text" name="update_answer" placeholder = "Odpoveď">
